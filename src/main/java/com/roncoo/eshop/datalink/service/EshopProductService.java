...
import com.roncoo.eshop.datalink.fallback.EshopProductServiceFallback;
...
public interface EshopProductService {
    ...
    String findProductPropertyProductById(@RequestParam(value = "productId") Long productId);
